...
import com.solana.jetpack_compose.ui.components.ProfileConstraint
...
class ProfileConstraintActivity : ComponentActivity() {
                ...
                Scaffold(
                    ...
                    LazyColumn {
                        ...
                        items(profileRecommendationList.value.size) { index ->
                            ...
                            ProfileConstraint(profile?.fullName.orEmpty(), profile?.city.orEmpty(), {
